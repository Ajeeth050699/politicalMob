      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
          <View style={s.card}>
            ...
            {!sent ?
            <>
                <Text style={s.cardTitle}>{literalT("Reset Password")}</Text>
                <Text style={s.cardSub}>{literalT("Enter the email address linked to your account")}</Text>

                <Text style={s.label}>{literalT("Email Address")}</Text>
                <View style={s.inputRow}>
                  <Text style={s.inputIcon}>✉️</Text>
                  <TextInput
                  style={s.input}
                  placeholder={literalT("Enter your email")}
                ...
                activeOpacity={0.85}>
                  ...
                  <Text style={s.btnTxt}>{literalT("📧 Send Reset Link")}</Text>
                  }
                  </LinearGradient>
                </TouchableOpacity>
              </> :
            ...
            <>
                ...
                <View style={s.successBox}>
                  ...
                  <Text style={s.successTitle}>{literalT("Check your inbox")}</Text>
                  <Text style={s.successSub}>{literalT("We sent a password reset link to")}
                  {'\n'}
                ...
                activeOpacity={0.85}>
                  ...
                  <LinearGradient colors={[T.maroon, T.maroonL]} style={s.btnGrad}>
                    <Text style={s.btnTxt}>{literalT("🔄 Try Again")}</Text>
                  </LinearGradient>
                </TouchableOpacity>
              </>
            }
            ...
            <View style={s.divider}>
              ...
              <Text style={s.divTxt}>{literalT("or")}</Text>
              <View style={s.divLine} />
            </View>
            ...
            <TouchableOpacity
              ...
              <Text style={s.loginBtnTxt}>{literalT("← Back to Sign In")}</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
