    ...
    <View style={s.root}>
      ...
      <View style={s.center}>
        ...
        <Animated.View style={{ opacity: subOpacity, transform: [{ translateY: subY }], alignItems: 'center', marginTop: 14 }}>
          ...
          <Text style={s.taglineSub}>{literalT("Empowering Citizens · Enabling Governance")}</Text>
        </Animated.View>
      ...
      <View style={s.bottom}>
        <Animated.View style={{ opacity: barOpacity, width: '100%', alignItems: 'center' }}>
          ...
          <Text style={s.loadingTxt}>{literalT("Loading your dashboard...")}</Text>
        </Animated.View>

        <View style={s.bottomRow}>
          <Text style={s.version}>{literalT("v1.0.0")}</Text>
          <Text style={s.govBadge}>{literalT("🇮🇳 Government of Tamil Nadu")}</Text>
