...
export default function CampsScreen({ navigation }) {
    ...
    return (
      <View style={[s.card, { borderTopColor: meta.color, borderTopWidth: 3 }]}>
        ...
        <View style={s.details}>
          ...
          {!!c.slots && <View style={s.detailRow}><Text style={s.di}>👥</Text><Text style={s.dt}>{c.slots}{literalT("slots available")}</Text></View>}
        </View>
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.85}>
            ...
            <Text style={s.regBtnTxt}>{literalT("📞 Register / Enquire")}</Text>
          </TouchableOpacity>
        }
      </View>);
  ...
  if (loading) return (
    <View style={s.center}>
      ...
      <Text style={{ color: T.textM, marginTop: 10 }}>{literalT("Loading camps...")}</Text>
    </View>);
    ...
    <View style={s.root}>
      ...
      <FlatList
        ...
        <View style={s.empty}>
            ...
            <Text style={s.emptyTitle}>{literalT("No camps found")}</Text>
            <Text style={s.emptySub}>{literalT("Try changing your filters or check back soon")}</Text>
          </View>
        } />
