import { literalT } from "../../i18n/runtimeTamil";import React, { useEffect, useState, useRef, useCallback } from 'react';
import {
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.8}>
            ...
            <View style={{ flex: 1 }}>
              ...
              <Text style={{ fontSize: 12, color: '#92400e' }}>{literalT("Tap here to update your Ward, Thokuthi, and District for accurate routing.")}</Text>
            </View>
    ...
    {/* ════ WEATHER & ALERTS ════ */}
        ...
        <FlatList
          ...
          <View style={s.emptyEmer}>
              <Text style={s.emptyTxt}>{literalT("No contacts found")}</Text>
            </View>
          } />
