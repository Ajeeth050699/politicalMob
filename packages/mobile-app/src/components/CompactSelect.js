import { literalT } from "../i18n/runtimeTamil";import React, { useMemo, useState } from 'react';
import {
  FlatList,
  Modal,
  Platform,
        ...
        <TouchableOpacity style={s.overlay} activeOpacity={1} onPress={() => setOpen(false)}>
          <TouchableOpacity style={s.sheet} activeOpacity={1}>
            ...
            <FlatList
              ...
              ListEmptyComponent={<Text style={s.empty}>{literalT("No options found")}</Text>} />
