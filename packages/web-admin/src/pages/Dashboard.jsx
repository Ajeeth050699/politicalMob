...
// â”€â”€ EXPORT UTILITIES â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const exportToHTML = (content, filename) => {
  ...
  Generated by People Connect Â· ${new Date().toLocaleString("en-IN")}</div></body></html>`;
...
const generateComplaintsReport = (complaints, stats) => {
  ...
  return `<h1>People Connect â€” Complaints Report</h1>
  <p>${total} Records Â· ${pct}% Completion Rate</p>
...
const generateWorkersReport = (workers) => {
  return `<h1>People Connect â€” Workers Report</h1>
...
const generateAnalyticsReport = (
  ...
  const pct = total > 0 ? Math.round((completed / total) * 100) : 0;
  return `<h1>People Connect â€” Analytics Report</h1>
  <p>Overall: ${pct}% Complete Â· ${total} Total Â· ${completed} Resolved</p>
  ...
  return (
    <div style={{ position: "relative" }} ref={ref}>
      ...
      {open && (
        ...
        >
          {[
            ["ðŸ“Š Export CSV", onCSV, T.green],
            ["ðŸŒ Export HTML", onHTML, T.blue],
            ["ðŸ“„ Export Report", onWord, T.maroon],
          ].map(([lbl, fn, color]) => (
            <button
              key={lbl}
              onClick={() => {
...
export default function AdminDashboard() {
  ...
  const [mockAggregate, setMockAggregate] = useState({ attempts: 0, avgAccuracy: 0, passRate: 0, categories: [], recent: [] });
  ...
  const AddWorkerModal = () => {
    ...
    return (
      <Modal title="ðŸ‘· Add New Worker" onClose={() => setModal(null)} wide>
        <form onSubmit={submit}>
          ...
          >
            ...
            <Field label="Thokuthi No." icon="ðŸ ">
              <input
                style={iSx}
                required
                value={f.thokuthi}
            ...
            <Field label="District" icon="ðŸ“">
              <DistrictSelect value={f.district} onChange={set("district")} />
            </Field>
          </div>
          <SubmitBtn loading={loading} label="âœ… Create Worker Account" />
        </form>
      </Modal>
    );
  };
  ...
  const AddComplaintModal = () => {
    ...
    return (
      <Modal title="ðŸ“ File Complaint" onClose={() => setModal(null)}>
        <form onSubmit={submit}>
          <Field label="Category" icon="ðŸ·ï¸">
          ...
          <Field label="Description" icon="ðŸ“">
            <textarea
          ...
          <SubmitBtn loading={loading} label="ðŸš€ Submit Complaint" />
        </form>
      </Modal>
    );
  };
  ...
  const AddNewsModal = () => {
    ...
    return (
      <Modal title="ðŸ“° Publish News" onClose={() => setModal(null)} wide>
        <form onSubmit={submit}>
          <Field label="Headline" icon="ðŸ“Œ">
            <input
              style={iSx}
              required
              value={f.title}
          ...
          <SubmitBtn loading={loading} label="ðŸ“¢ Publish" />
        </form>
      </Modal>
    );
  };
  ...
  const AddCampModal = () => {
    ...
    return (
      <Modal title="ðŸ•ï¸ Create Welfare Camp" onClose={() => setModal(null)} wide>
        <form onSubmit={submit}>
          <Field label="Camp Name" icon="ðŸ•ï¸">
            <input
              style={iSx}
              required
              value={f.name}
          ...
          >
            ...
            <Field label="District" icon="ðŸ™ï¸">
              <DistrictSelect value={f.district} onChange={set("district")} />
            </Field>
            <Field label="Date" icon="ðŸ“…">
              <input
                style={iSx}
                required
                type="date"
          ...
          <SubmitBtn loading={loading} label="ðŸ•ï¸ Create Camp" />
        </form>
      </Modal>
    );
  };
  ...
  const UploadVideoModal = () => {
    ...
    return (
      <Modal title="ðŸŽ¥ Upload Video" onClose={() => setModal(null)}>
        <form onSubmit={submit}>
          <Field label="Title" icon="ðŸ“Œ">
            <input
              style={iSx}
              required
              value={f.title}
          ...
          <SubmitBtn loading={loading} label="ðŸ“¤ Upload" />
        </form>
      </Modal>
    );
  };
  ...
  const CreateExamModal = () => {
      ...
      try {
        ...
        setExams((p) => [
          ...p,
          {
            ...
            questions: data.questions || data.questions?.length || f.questions.length,
    ...
    return (
      <Modal title="ðŸ“ Create Exam" onClose={() => setModal(null)} wide>
        <form onSubmit={submit}>
          <div
            style={{
              display: "grid",
          ...
          >
            ...
            <Field label="Total Marks" icon="ðŸŽ¯">
              <input
                style={iSx}
                type="number"
                value={f.totalMarks}
          ...
          {f.questions.length > 0 && (
            ...
            >
              ...
              >
                {f.questions.length} QUESTION(S) ADDED âœ…
              </p>
              {f.questions.map((q, i) => (
                <div
                  key={i}
          ...
          >
            ...
            <Field label="Correct Answer" icon="âœ…">
              <select
                style={sSx}
                value={q.answer}
                onChange={(e) =>
          ...
          <SubmitBtn loading={loading} label="ðŸ“ Create Exam" />
        </form>
      </Modal>
    );
  };
  ...
  const CreateJobModal = () => {
    ...
    const submit = async (e) => {
      ...
      try {
        ...
        const { data } = await axios.post(`${API}/api/education/government-jobs`, payload, getConfig());
        setGovJobs((p) => [data, ...p]);
      ...
      <Modal title="Create Government Job" onClose={() => setModal(null)} wide>
        <form onSubmit={submit}>
          <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 12 }}>
            <Field label="Job Title" icon=""><input style={iSx} required value={f.title} onChange={set("title")} /></Field>
            <Field label="Department" icon=""><input style={iSx} required value={f.department} onChange={set("department")} /></Field>
            <Field label="Category" icon=""><input style={iSx} value={f.category} onChange={set("category")} /></Field>
            <Field label="Location" icon=""><input style={iSx} value={f.location} onChange={set("location")} /></Field>
            <Field label="Qualification" icon=""><input style={iSx} value={f.qualification} onChange={set("qualification")} /></Field>
            <Field label="Vacancies" icon=""><input style={iSx} type="number" value={f.vacancies} onChange={set("vacancies")} /></Field>
            <Field label="Salary" icon=""><input style={iSx} value={f.salary} onChange={set("salary")} /></Field>
            ...
            <Field label="Apply By" icon=""><input style={iSx} type="date" value={f.applyBy} onChange={set("applyBy")} /></Field>
            <Field label="Exam Date" icon=""><input style={iSx} type="date" value={f.examDate} onChange={set("examDate")} /></Field>
            <Field label="Year" icon=""><input style={iSx} type="number" value={f.year} onChange={set("year")} /></Field>
            <Field label="Tags" icon=""><input style={iSx} value={f.tags} onChange={set("tags")} placeholder="TNPSC, Police, Group IV" /></Field>
            <Field label="Application URL" icon=""><input style={iSx} value={f.applicationUrl} onChange={set("applicationUrl")} /></Field>
            <Field label="Notification URL" icon=""><input style={iSx} value={f.notificationUrl} onChange={set("notificationUrl")} /></Field>
          </div>
  ...
  const SendNotifModal = () => {
    ...
    return (
      <Modal title="ðŸ“£ Send Announcement" onClose={() => setModal(null)}>
        <form onSubmit={submit}>
          <Field label="Message" icon="ðŸ’¬">
            <textarea
          ...
          <SubmitBtn loading={loading} label="ðŸ“£ Send to All Users" />
        </form>
      </Modal>
    );
  };
  ...
  const IssueCertModal = () => (
    <Modal title="ðŸ† Certificates" onClose={() => setModal(null)}>
      <div style={{ textAlign: "center", padding: "16px 0" }}>
        ...
        >
          Certificates are <strong>auto-issued</strong> when a user scores â‰¥ 60%
          in any exam.
          <br />
          Exams: <strong>{exams.length}</strong> Â· Certificates issued:{" "}
  ...
  const NAV = [
    ...
    { id: "news", label: "News & Camps", icon: "ðŸ“°" },
  ...
  const SidebarContent = () => (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontSize: 17 }}>ðŸšª</span>
  ...
  const Topbar = () => {
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div style={{ minWidth: 0 }}>
            ...
            {!isMobile && (
              ...
              >
                People Connect Â· Tamil Nadu Government Portal
              </div>
            )}
          </div>
        </div>
        ...
        >
          {/* Completion badge â€” hidden on xs */}
          {!isMobile && (
            <div
              style={{
                display: "flex",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {[
              ["ðŸ“‹", stats.totalComplaints, "Total", "#fca5a5"],
              ["â³", stats.pending, "Pending", "#fde68a"],
              ["âœ…", stats.completed, "Done", "#86efac"],
              ["ðŸ‘¥", stats.activeWorkers, "Workers", "#93c5fd"],
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ minWidth: 0 }}>
                          ...
                          >
                            {c.user} Â· {c.thokuthi} Â· {c.district}
                          </div>
                        </div>
                      </div>
                      <span
  ...
  const PageWorkers = () => (
    ...
    >
      ...
      >
        <input
          placeholder="ðŸ”  Search workers, thokuthi, district..."
          value={searchWorker}
      ...
      >
        ...
        >
          <span style={{ fontSize: 36, marginBottom: 10 }}>âž•</span>
          <span
            style={{
              fontFamily: "'Source Sans 3',sans-serif",
              fontSize: 14,
      ...
      >
        ...
        {tab === "news" ? (
          ...
          >
            ...
            >
              <span style={{ fontSize: 34, marginBottom: 8 }}>âž•</span>
              <span
                style={{
                  fontFamily: "'Source Sans 3',sans-serif",
                  fontSize: 13,
  ...
  const PageEducation = () => (
    ...
    >
        ...
        {videos.map((v) => (
          ...
          >
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                {v.category} Â· {(v.views || 0).toLocaleString()} views
              </div>
            </div>
            <span
              style={{
        ...
        >
          ...
          {exams.map((e) => (
            ...
            >
              ...
              >
                {e.questions} questions Â· {e.duration} Â· {e.taken} attempts
              </div>
            </div>
          ))}
        </div>
      ...
      <div
        style={{
          gridColumn: isMobile || isTablet ? "auto" : "1 / -1",
          background: "#fff",
          borderRadius: 16,
          padding: isMobile ? "16px" : "22px 24px",
          border: `1px solid ${T.border}`,
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 18, gap: 12, flexWrap: "wrap" }}>
          <div>
            <div style={{ fontFamily: "'Playfair Display',serif", fontWeight: 700, fontSize: isMobile ? 15 : 18, color: T.text }}>Government Jobs</div>
            <div style={{ fontFamily: "'Source Sans 3',sans-serif", fontSize: 12, color: T.textM, marginTop: 3 }}>
              {jobSummary.live} live · {jobSummary.upcoming} upcoming · {jobSummary.previous} previous · {jobSummary.applications} tracked applications
            </div>
          </div>
          <ActionBtn label="+ Add Job" onClick={() => setModal("createJob")} gold />
        </div>
        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(4,1fr)", gap: 10, marginBottom: 16 }}>
          {[
            ...
            <div key={label} style={{ background: T.bg, borderRadius: 12, padding: 14, border: `1px solid ${T.border}` }}>
              <div style={{ color, fontSize: 24, fontWeight: 900 }}>{value}</div>
              <div style={{ color: T.textM, fontSize: 11, fontWeight: 700 }}>{label}</div>
            </div>
          ))}
        </div>
        {govJobs.length === 0 ? (
          <div style={{ color: T.textM, textAlign: "center", padding: "24px 0" }}>No government jobs created yet</div>
        ) : (
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 860 }}>
              <thead>
                <tr style={{ background: T.bg }}>
                  {["Title", "Department", "Category", "Status", "Vacancies", "Apply By", "Applications"].map((h) => (
                    <th key={h} style={{ textAlign: "left", padding: 12, fontSize: 12, color: T.textM }}>{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
                {govJobs.map((job) => (
                  <tr key={job.id} style={{ borderBottom: `1px solid ${T.border}` }}>
                    <td style={{ padding: 12, fontWeight: 700, color: T.text }}>{job.title}</td>
                    <td style={{ padding: 12, color: T.textL }}>{job.department}</td>
                    <td style={{ padding: 12, color: T.textL }}>{job.category}</td>
                    <td style={{ padding: 12, color: job.status === "live" ? T.green : job.status === "upcoming" ? T.blue : T.textM, fontWeight: 800 }}>{job.status}</td>
                    <td style={{ padding: 12 }}>{job.vacancies || 0}</td>
                    <td style={{ padding: 12 }}>{job.applyBy ? new Date(job.applyBy).toLocaleDateString("en-IN") : "-"}</td>
                    <td style={{ padding: 12, color: T.maroon, fontWeight: 800 }}>{job.applications || 0}</td>
                  </tr>
                ))}
              </tbody>
            </table>
      ...
      >
        <div style={{ fontFamily: "'Playfair Display',serif", fontWeight: 700, fontSize: isMobile ? 15 : 18, color: T.text, marginBottom: 12 }}>Mock Test Analytics</div>
        ...
        {(mockAggregate.recent || []).slice(0, 6).map((r) => (
          <div key={r.id} style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "2fr 1fr 1fr 1fr", gap: 8, padding: "10px 0", borderBottom: `1px solid ${T.border}` }}>
            <span style={{ fontWeight: 700, color: T.text }}>{r.test}</span>
            <span style={{ color: T.textL }}>{r.user}</span>
            <span style={{ color: T.blue, fontWeight: 800 }}>{r.accuracy}% accuracy</span>
            <span style={{ color: T.maroon, fontWeight: 800 }}>{r.score}/{r.total}</span>
          </div>
        ))}
      </div>
  // â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
    ...
    >
      ...
      >
        <div>
          ...
          >
            {stats.completed} completed Â· {stats.pending} pending Â·{" "}
  ...
  // â”€â”€ ATTACHMENT VIEWER â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    >
      ...
      {isMobile && (
        ...
        >
          ...
          >
            <span style={{ fontSize: 18 }}>â€¢â€¢â€¢</span>
            <span
              style={{
                fontFamily: "'Source Sans 3',sans-serif",
                fontSize: 9,
