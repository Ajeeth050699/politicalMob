...
export default function Home() {
  ...
  const handleAuthSubmit = async () => {
    ...
    try {
      ...
      error.request ? `Cannot reach backend at ${API_URL}. Check that the API server is running and CORS allows this web app.` : error.message) ||
      `An unknown error occurred during ${authTab}.`;
            ...
            <div style={{ maxWidth: 270 }}>
              ...
              <p
                style={{
                  ...
                  color: "rgba(255,255,255,0.35)",
                  lineHeight: 1.7
                }}>{literalT("Political Public Service & Complaint Management Platform for Tamil Nadu.")}
            ...
            <div
              ...
              <>
                    ...
                    style={{
                      ...
                      display: "block",
                      marginBottom: 8
                    }}>{literalT("Profile Photo (Live Capture) *")}
                    ...
                    <>
                              <img src={authForm.profilePhoto} style={{ width: "100%", height: "100%", objectFit: "cover" }} alt={literalT("Profile")} />
                              <button
                        type="button"
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="pri-btn"
                        style={{ padding: "8px 16px", fontSize: 13 }}>{literalT("Start Camera")}
                  ...
                  <span
                    style={{
                      ...
                      marginTop: 3,
                      display: "block"
                    }}>{literalT("Live profile photo is required")}
                ...
                <span
                  style={{
                    ...
                    marginTop: 3,
                    display: "block"
                  }}>{literalT("Please enter a valid email")}
                ...
                <span
                  style={{
                    ...
                    marginTop: 3,
                    display: "block"
                  }}>{literalT("Min 6 characters required")}
              ...
              <div>
                ...
                <span
                  style={{
                    ...
                    marginTop: 3,
                    display: "block"
                  }}>{literalT("Passwords do not match")}
              ...
              <>
                    ...
                    style={{
                      ...
                      display: "block",
                      marginBottom: 5
                    }}>{literalT("Thokuthi / Constituency")}
                  ...
                  style={{
                    ...
                    } />{literalT("Tamil Nadu overall access")}
